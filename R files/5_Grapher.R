...
# cleaning = decibels are close to zero, we want the first position that's non-zero
# and the last position

# look across decibel vector
# pull out all of the positions that are bigger than 70
# region where it first starts being 70 and then a gaps
# 

# take a window of length 20 -- calc the avg decibel
# gonan smooth out the bumps
# make the gap the same size of the zeros
# then we can find where the gaps are and then find the 70 decibels 
